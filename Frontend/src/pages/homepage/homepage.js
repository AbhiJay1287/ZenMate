...
//             <h4 className={styles.text}>ZenMate</h4>
...
//             }}
//           >
//             Click here to Chat...<span className={styles.cursor}></span>
//           </div>
//         </section>
...
//         <h1 className="text-center text-3xl font-bold">Article's for You</h1>
...
//           </div>
//           <div className="text-center">© 2024 by Team C15</div>
//         </div>
//       </footer>
  ...
  return (
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
      <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">
        Copyright Ⓒ 2024 ZenMate. All Rights Reserved.
      </p>
